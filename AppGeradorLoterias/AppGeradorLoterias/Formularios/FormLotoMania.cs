...
namespace AppGeradorLoterias.Formularios
{
    public partial class FormLotoMania : Form
    {
        ...
        {
            InitializeComponent();
            dgvNumeros.AlternatingRowsDefaultCellStyle.BackColor = Color.Orange;
        }
        ...
        private void btGerar_Click(object sender, EventArgs e)
        {
            ...
            while (contador < 20)
            {
                temporario = randomico.Next(1, 51);
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            var planilha = pasta.Worksheet(2);
        ...
        private void AnalisarJogo(int par, int impar)
        {
            ...
            if (impar == 11) { lbClass.Text = "Ótimo Jogo!"; lbClass.ForeColor = Color.Green; }
            if (impar == 9) { lbClass.Text = "Bom Jogo!"; lbClass.ForeColor = Color.Orange; }
            if (impar == 12) { lbClass.Text = "Jogo Regular!"; lbClass.ForeColor = Color.OrangeRed; }
