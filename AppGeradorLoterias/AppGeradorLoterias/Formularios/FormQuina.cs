...
namespace AppGeradorLoterias.Formularios
{
    public partial class FormQuina : Form
    {
        ...
        private void AnalisarJogo(int par, int impar)
        {
            ...
            if (impar == 1) { lbClass.Text = "Bom Jogo!"; lbClass.ForeColor = Color.Orange; }
            if (impar == 4) { lbClass.Text = "Jogo Regular!"; lbClass.ForeColor = Color.OrangeRed; }
        ...
        private void btGerar_Click(object sender, EventArgs e)
        {
            ...
            while (contador < 15)
            {
                temporario = randomico.Next(1, 81);
